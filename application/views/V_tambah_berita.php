...
<div class="mr-3 ml-3 mr-sm-3 ml-sm-3 mr-md-5 ml-md-5 mt-5 mb-5">
  <?php $this->load->view('V_template_breadcrumb', ['viewName' => 'V_tambah_berita']) ?>
  <div class="text-left ml-3"><h5>Tambah Berita</h5></div>
  <div class="col-md-8 col-lg-6">
    <form method="post" action="<?php echo base_url().'tambah-berita'; ?>" enctype="multipart/form-data">
      <fieldset class="mt-4">
        ...
        <div class="form-group col-md-12">
          ...
          <textarea class="form-control" rows="25" name="isi" placeholder="Isi"></textarea>
        </div>
