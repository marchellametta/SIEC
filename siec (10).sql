...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2018 at 03:47 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `search_panitia_ec` (IN `nama` VARCHAR(100))  NO SQL
select * from user join user_roles on user.id_user = user_roles.user_id where user_roles.role_id = 1 AND user.nama LIKE CONCAT('%', nama, '%')$$
...
(1, 'images/banner/background.png'),
(2, 'images/banner/63295.jpg'),
...
(2, 'a', 'bbb', 'images/berita/dummy2.png');
...
--
-- Stand-in structure for view `data_modul`
-- (See below for the actual view)
--
CREATE TABLE `data_modul` (
`id_modul` int(11)
,`link_modul` varchar(1000)
,`id_topik` int(11)
...
--
-- Stand-in structure for view `data_pembayaran_peserta_lepas`
-- (See below for the actual view)
--
CREATE TABLE `data_pembayaran_peserta_lepas` (
`id_user` int(11)
,`nama` varchar(200)
,`id_topik` int(11)
,`nama_topik` varchar(500)
...
--
-- Stand-in structure for view `data_pembayaran_peserta_tetap`
-- (See below for the actual view)
--
CREATE TABLE `data_pembayaran_peserta_tetap` (
`id_user` int(11)
,`nama` varchar(200)
,`id_ec` int(11)
,`tagihan` int(11)
...
CREATE TABLE `ec` (
  ...
  `biaya_per_topik` int(11) NOT NULL,
  `kapasitas_peserta` int(11) NOT NULL,
...
(1, 1, 1, 2018, 'Philosophy of Mind', 1, 2, 350000, 'alskjlsadjflajsdfljasldjflasjdlfjlasjfjjjjjjjjj', 'images/mind.jpg', 40000, 0, 20, 'Modul/Skripsi_2.pdf'),
(2, 2, 1, 2018, 'Nasib Agama Lokal', 2, 2, 400000, 'lsadfjalskdjflaksj', 'images/dummy.jpg', 50000, 10, NULL, NULL),
(5, 2, 2, 2017, 'Udah Lewat', 1, 1, 300000, 'tes history', 'images/dummy3.jpg', 0, 0, NULL, NULL),
...
(19, 1, 2, 2018, 'Skripsi 2', 1, 1, 425000, 'Kelas ini untuk coba tambah dan edit', 'images/Skripsi_2.png', 0, 100, NULL, 'Modul/Skripsi_2.pdf'),
(21, 1, 1, 2018, 'cobain', 2, 1, 300000, 'asdasdasdasdasd', 'images/cobain.jpg', 0, 0, NULL, 'Modul/cobain.pdf'),
(30, 1, 1, 2010, 'Cobain narasumber', 1, 1, 123, 'asdfasdf', '', 0, 0, NULL, '');
...
(7, '2018-04-17', 'Ruang 10317', '2018-03-17', '2018-03-17', 1, 2),
(8, '2018-04-25', 'Ruang 9122', '2018-03-10', '2018-03-10', 1, 3),
(9, '2018-04-25', 'Ruang Auditorium', '2018-03-10', '2018-03-10', 1, 4),
(10, '2018-04-25', 'Ruang Auditorium', '2018-03-10', '2018-03-10', 1, 5),
(15, '2018-06-20', 'Rumah', '3:36 PM', '3:36 PM', 0, 13),
(17, '2018-03-20', 'Rumah', '3:58 PM', '3:58 PM', 0, 16),
(19, '2018-03-21', 'asdasda', '12:45 PM', '12:45 PM', 0, 18),
(28, '2018-04-13', 'asdfasf', '8:40 AM', '8:40 AM', 0, 27);
...
CREATE TABLE `modul` (
  ...
  `link_modul` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `modul` (`id_modul`, `link_modul`) VALUES
(2, 'Modul/Gmail_-_Your_trip_with_GO-JEK_on_Friday,_16_March_2018.pdf'),
(3, 'Modul/Gmail_-_Your_trip_with_GO-JEK_on_Friday,_16_March_2018.pdf'),
(4, 'Modul/Gmail_-_Your_trip_with_GO-JEK_on_Friday,_16_March_2018-1_(1).pdf'),
(5, 'Modul/tesprint.pdf'),
(6, 'Modul/tesprint.pdf');

-- --------------------------------------------------------

--
-- Table structure for table `modul_topik`
--

CREATE TABLE `modul_topik` (
  `id_modul` int(11) NOT NULL,
  `id_topik` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `modul_topik`
--

INSERT INTO `modul_topik` (`id_modul`, `id_topik`) VALUES
(2, 1),
(3, 1),
(4, 1),
(5, 2),
...
(2, 'asdasdasdasdasda', 'asdasd', 'asdasdasd', 'asdasdasdasd'),
(9, ' pa', ' la', ' ja', 'a'),
(10, ' pb', ' lb', ' jb', 'b');
...
--
-- Table structure for table `pembayaran_peserta_lepas`
--

CREATE TABLE `pembayaran_peserta_lepas` (
...
--
-- Dumping data for table `pembayaran_peserta_lepas`
--

INSERT INTO `pembayaran_peserta_lepas` (`id_peserta`, `id_ec`, `id_topik`, `tagihan`, `status_lunas`) VALUES
(7, 1, 1, 40000, 1),
(7, 2, 3, 40000, 0),
(8, 1, 1, 40000, 0),
(8, 1, 2, 40000, 1);
...
--
-- Table structure for table `pembayaran_peserta_tetap`
--

CREATE TABLE `pembayaran_peserta_tetap` (
  `id_peserta` int(11) NOT NULL,
  `id_ec` int(11) NOT NULL,
  `tagihan` int(11) NOT NULL,
  `telah_bayar` int(11) NOT NULL DEFAULT '0',
  `status_lunas` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pembayaran_peserta_tetap`
--

INSERT INTO `pembayaran_peserta_tetap` (`id_peserta`, `id_ec`, `tagihan`, `telah_bayar`, `status_lunas`) VALUES
(8, 21, 300000, 0, 0),
(21, 1, 350000, 300000, 0),
(8, 2, 400000, 0, 0);
...
(20, 'editkelas', 'Edit Kelas'),
(21, 'pendaftaran_panitia', 'Pendaftaran Panitia'),
(22, 'pendaftaran_daftar-panitia', 'Submit Pendaftaran Panitia'),
(25, 'kelola-beranda', 'Kelola Beranda'),
(26, 'kelola-berita', 'Kelola Berita'),
(27, 'hapus-berita', 'Hapus Berita'),
(28, 'tambah-berita', 'Tambah Berita'),
(29, 'acl', 'Kelola ACL'),
(30, 'kelas_peserta_topik', 'Daftar peserta topik'),
(31, 'kelas_peserta', 'Daftar peserta');
...
INSERT INTO `user` (`id_user`, `nama`, `alamat`, `pekerjaan`, `lembaga`, `pendidikan_terakhir`, `kota`, `no_hp`, `email`, `password`, `agama`, `foto`) VALUES
...
(8, 'Kelvin Tandika', 'Taman Holis Indah', 'Mahasiswa', 'UNPAR', 1, 'Bandung', '087822714078', 'kelvin@mail.com', '$2y$10$CgXW5YHHbM/00WfbskrhHeVHuUfcYH7.32ea/4hjECaDg7gP1oz4S', 0, 'images/foto/dummy3.jpg'),
...
(21, 'PanPan', 'Cave', 'Freelance', 'Something', 1, 'Bandung', '087822714078', 'panpan@mail.com', '$2y$10$BGjD8OY/xdILAL45bQESq.LHTAHQ7jrhlR0nOefZv5WmRLw2hHVXO', 1, ''),
(22, 'someone', 'somewhere', 'something', 'something', 1, 'somewhere', '087822714078', 'someone@mail.com', '$2y$10$qUgA.a37MkE8sOlFeVSTWuxOxA6SQb2GOriT7t65y6jt95XFMBtwO', 1, 'images/foto/dummy3.jpg'),
(23, 'iim', 'kopo', 'karyawan', 'unpar', 1, 'Bandung', '098098098', '', '$2y$10$Kf6xq7Nx/JwcnXNkFbTJOum1U6QgIfDKTSJA7ERz9wv1Wh.gR1Uhy', 1, '');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `data_ec_panitia`  AS  select `panitia_ec`.`id_panitia` AS `id_panitia`,`ec`.`id_ec` AS `id_ec`,`jenisec`.`jenis_ec` AS `jenis_ec`,`ec`.`semester_pelaksanaan` AS `semester_pelaksanaan`,`ec`.`tahun_pelaksanaan` AS `tahun_pelaksanaan`,`ec`.`tema_ec` AS `tema_ec`,`ec`.`status_evaluasi` AS `status_evaluasi`,`ec`.`status_peserta` AS `status_peserta`,`ec`.`biaya` AS `biaya`,`ec`.`deskripsi` AS `deskripsi`,`ec`.`gambar` AS `gambar`,`ec`.`biaya_per_topik` AS `biaya_per_topik`,`ec`.`kapasitas_peserta` AS `kapasitas_peserta`,`ec`.`batas_lulus` AS `batas_lulus`,`ec`.`modul_pdf` AS `modul_pdf` from ((`panitia_ec` join `ec` on((`panitia_ec`.`id_ec` = `ec`.`id_ec`))) join `jenisec` on((`jenisec`.`id_jenis_ec` = `ec`.`id_jenis_ec`))) ;

-- --------------------------------------------------------

--
-- Structure for view `data_modul`
--
DROP TABLE IF EXISTS `data_modul`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `data_modul`  AS  select `modul`.`id_modul` AS `id_modul`,`modul`.`link_modul` AS `link_modul`,`topik_ec`.`id_topik` AS `id_topik`,`topik_ec`.`nama_topik` AS `nama_topik`,`topik_ec`.`id_ec` AS `id_ec` from ((`modul` join `modul_topik` on((`modul`.`id_modul` = `modul_topik`.`id_modul`))) join `topik_ec` on((`topik_ec`.`id_topik` = `modul_topik`.`id_topik`))) ;

-- --------------------------------------------------------

--
-- Structure for view `data_pembayaran_peserta_lepas`
--
DROP TABLE IF EXISTS `data_pembayaran_peserta_lepas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `data_pembayaran_peserta_lepas`  AS  select `user`.`id_user` AS `id_user`,`user`.`nama` AS `nama`,`topik_ec`.`id_topik` AS `id_topik`,`topik_ec`.`nama_topik` AS `nama_topik`,`pembayaran_peserta_lepas`.`id_ec` AS `id_ec`,`pembayaran_peserta_lepas`.`tagihan` AS `tagihan`,`pembayaran_peserta_lepas`.`status_lunas` AS `status_lunas` from ((`user` join `pembayaran_peserta_lepas` on((`user`.`id_user` = `pembayaran_peserta_lepas`.`id_peserta`))) join `topik_ec` on((`topik_ec`.`id_topik` = `pembayaran_peserta_lepas`.`id_topik`))) ;

-- --------------------------------------------------------

--
-- Structure for view `data_pembayaran_peserta_tetap`
--
DROP TABLE IF EXISTS `data_pembayaran_peserta_tetap`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `data_pembayaran_peserta_tetap`  AS  select `user`.`id_user` AS `id_user`,`user`.`nama` AS `nama`,`pembayaran_peserta_tetap`.`id_ec` AS `id_ec`,`pembayaran_peserta_tetap`.`tagihan` AS `tagihan`,`pembayaran_peserta_tetap`.`telah_bayar` AS `telah_bayar`,`pembayaran_peserta_tetap`.`status_lunas` AS `status_lunas` from (`user` join `pembayaran_peserta_tetap` on((`user`.`id_user` = `pembayaran_peserta_tetap`.`id_peserta`))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `data_topik`  AS  select `topik_ec`.`id_topik` AS `id_topik`,`topik_ec`.`id_ec` AS `id_ec`,`topik_ec`.`nama_topik` AS `nama_topik`,`jadwal`.`tanggal` AS `tanggal`,`jadwal`.`lokasi` AS `lokasi`,`jadwal`.`jam_mulai` AS `jam_mulai`,`jadwal`.`jam_selesai` AS `jam_selesai`,`narasumber`.`nama` AS `nama`,`narasumber`.`profesi` AS `profesi`,`narasumber`.`lembaga` AS `lembaga`,`narasumber`.`jabatan` AS `jabatan` from (((`jadwal` join `topik_ec` on((`jadwal`.`id_topik` = `topik_ec`.`id_topik`))) join `narasumber_topik` on((`narasumber_topik`.`id_topik` = `topik_ec`.`id_topik`))) join `narasumber` on((`narasumber`.`id_narasumber` = `narasumber_topik`.`id_narasumber`))) ;
...
--
-- Indexes for table `modul_topik`
--
ALTER TABLE `modul_topik`
...
--
-- Indexes for table `pembayaran_peserta_lepas`
--
ALTER TABLE `pembayaran_peserta_lepas`
  ADD KEY `id_peserta` (`id_peserta`),
  ADD KEY `id_topik` (`id_topik`),
  ADD KEY `id_ec` (`id_ec`);

--
-- Indexes for table `pembayaran_peserta_tetap`
--
ALTER TABLE `pembayaran_peserta_tetap`
  ADD KEY `id_ec` (`id_ec`),
  ADD KEY `id_peserta` (`id_peserta`);
...
--
ALTER TABLE `ec`
  MODIFY `id_ec` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `narasumber`
  MODIFY `id_narasumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `topik_ec`
  MODIFY `id_topik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
-- Constraints for table `modul_topik`
--
ALTER TABLE `modul_topik`
  ADD CONSTRAINT `modul_topik_ibfk_1` FOREIGN KEY (`id_modul`) REFERENCES `modul` (`id_modul`),
  ADD CONSTRAINT `modul_topik_ibfk_2` FOREIGN KEY (`id_topik`) REFERENCES `topik_ec` (`id_topik`);
...
--
-- Constraints for table `pembayaran_peserta_lepas`
--
ALTER TABLE `pembayaran_peserta_lepas`
  ADD CONSTRAINT `pembayaran_peserta_lepas_ibfk_1` FOREIGN KEY (`id_peserta`) REFERENCES `user` (`id_user`),
  ADD CONSTRAINT `pembayaran_peserta_lepas_ibfk_2` FOREIGN KEY (`id_topik`) REFERENCES `topik_ec` (`id_topik`),
  ADD CONSTRAINT `pembayaran_peserta_lepas_ibfk_3` FOREIGN KEY (`id_ec`) REFERENCES `ec` (`id_ec`);

--
-- Constraints for table `pembayaran_peserta_tetap`
--
ALTER TABLE `pembayaran_peserta_tetap`
  ADD CONSTRAINT `pembayaran_peserta_tetap_ibfk_2` FOREIGN KEY (`id_ec`) REFERENCES `ec` (`id_ec`),
  ADD CONSTRAINT `pembayaran_peserta_tetap_ibfk_3` FOREIGN KEY (`id_peserta`) REFERENCES `user` (`id_user`);
