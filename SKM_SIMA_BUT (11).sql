...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2017 at 04:54 PM
...
--
-- Creation: Jul 05, 2017 at 01:25 PM
--
...
--
-- RELATIONSHIPS FOR TABLE `akdadm_mt_mhs`:
--
...
--
-- RELATIONSHIPS FOR TABLE `glb_mt_unit`:
--
...
--
-- RELATIONSHIPS FOR TABLE `sima_acuan_aset_dt`:
--   `ID_ASET`
...
--
-- RELATIONSHIPS FOR TABLE `sima_aset_mt`:
--   `ASET_KATEGORI_ID`
...
--
-- RELATIONSHIPS FOR TABLE `sima_barang_mt`:
--   `ID_ASET`
--       `sima_aset_mt` -> `ID_ASET`
...
--
-- RELATIONSHIPS FOR TABLE `sima_detil_peminjaman_dt`:
--   `ID_ASET`
--       `sima_aset_mt` -> `ID_ASET`
--   `ID_PEMINJAMAN`
...
--
-- RELATIONSHIPS FOR TABLE `sima_detil_peminjaman_kategori_spesifik_dt`:
--   `ID_PEMINJAMAN`
--       `sima_peminjaman_tr` -> `ID_PEMINJAMAN`
--   `ID_KATEGORI_SPESIFIK`
--       `sima_kategori_spesifik_mt` -> `ID_KATEGORI_SPESIFIK`
...
--
-- RELATIONSHIPS FOR TABLE `sima_detil_peminjaman_perlengkapan_dt`:
--   `ID_PERLENGKAPAN`
...
--
-- RELATIONSHIPS FOR TABLE `sima_fasilitas_glr_dt`:
--   `ID_GLR`
--       `sima_glr_mt` -> `ID_GLR`
--   `ID_BARANG`
...
--
-- RELATIONSHIPS FOR TABLE `sima_glr_mt`:
--   `ID_ASET`
--       `sima_aset_mt` -> `ID_ASET`
--   `PARENT_ID`
--       `sima_glr_mt` -> `ID_GLR`
...
(3, 5, 1, '01020000', 'Lantai 2 Gedung 0 (Rektorat)', 'images/GLR/01020000.jpg', 0, 3, 30, 20, 'rgba(0,0,0,1)', 1, 0),
...
--
-- RELATIONSHIPS FOR TABLE `sima_kategori_mt`:
--
...
--
-- RELATIONSHIPS FOR TABLE `sima_kategori_spesifik_mt`:
--
...
--
-- RELATIONSHIPS FOR TABLE `sima_kendaraan_mt`:
--   `ID_ASET`
--       `sima_aset_mt` -> `ID_ASET`
--   `ID_KATEGORI_SPESIFIK`
--       `sima_kategori_spesifik_mt` -> `ID_KATEGORI_SPESIFIK`
...
--
-- RELATIONSHIPS FOR TABLE `sima_lokasi_mt`:
--
...
--
-- RELATIONSHIPS FOR TABLE `sima_pegawai_unpar_bertugas_dt`:
--   `V_NO_PEG`
...
--
-- Creation: Jul 05, 2017 at 02:48 PM
--
...
--
-- RELATIONSHIPS FOR TABLE `sima_peminjaman_tr`:
...
(37, NULL, '1', 'udahbener', 'unpar', 0, 'Surat/udahbener.pdf', '', 3, NULL, '2017-06-10 10:55:25', '2017-06-10 10:55:25', '2017-06-10 00:00:06', '2014730012', '2014730012', '2017-06-10 00:00:06', '2017-06-10 00:00:06', '2017-06-10 10:55:25', NULL, NULL, NULL, NULL),
(38, NULL, '1', 'cobalagi', 'bandung', 0, 'Surat/cobalagi.pdf', '', 3, NULL, '2017-06-10 11:02:12', '2017-06-10 11:02:12', '2017-06-10 00:00:06', '2014730012', '2014730012', '2017-06-10 00:00:06', '2017-06-10 00:00:06', '2017-06-10 11:02:12', NULL, NULL, NULL, NULL),
...
--
-- RELATIONSHIPS FOR TABLE `sima_perlengkapan_mt`:
--   `ID_KATEGORI_SPESIFIK`
--       `sima_kategori_spesifik_mt` -> `ID_KATEGORI_SPESIFIK`
--
...
--
-- RELATIONSHIPS FOR TABLE `sima_tabel_acuan_mt`:
--
...
--
-- Creation: Jul 05, 2017 at 01:26 PM
--
...
--
-- RELATIONSHIPS FOR TABLE `sima_template_surat_mt`:
--
...
--
-- RELATIONSHIPS FOR TABLE `simpeg_mt_induk_peg`:
--
...
CREATE TABLE `vw_sima_acuan_jenis_glr` (
`ID_ACUAN` int(11)
...
CREATE TABLE `vw_sima_acuan_kondisi` (
`ID_ACUAN` int(11)
,`V_JENIS_ACUAN` varchar(50)
,`V_NILAI_ACUAN` varchar(5)
...
CREATE TABLE `vw_sima_kendaraan` (
`ID_KENDARAAN` int(11)
,`ID_ASET` int(11)
...
CREATE TABLE `vw_sima_peminjaman` (
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `skm_sima_but`.`vw_sima_pemohon`  AS  select `skm_sima_but`.`akdadm_mt_mhs`.`V_NPM` AS `V_NO_PEMOHON`,`skm_sima_but`.`akdadm_mt_mhs`.`V_NAMA` AS `V_NAMA_PEMOHON`,`skm_sima_but`.`akdadm_mt_mhs`.`V_KODE_PRODI` AS `V_KODE_PRODI_UNIT_PEMOHON`,`skm_sima_but`.`akdadm_mt_mhs`.`V_NAMA_PRODI` AS `V_NAMA_UNIT_PRODI_PEMOHON`,`skm_sima_but`.`akdadm_mt_mhs`.`V_EMAIL` AS `V_EMAIL_PEMOHON`,`skm_sima_but`.`akdadm_mt_mhs`.`V_TELP_HP` AS `V_TELP_HP_PEMOHON`,1 AS `N_STATUS_PEMOHON` from `skm_sima_but`.`akdadm_mt_mhs` union select `skm_sima_but`.`simpeg_mt_induk_peg`.`V_NO_PEG` AS `V_NO_PEMOHON`,`skm_sima_but`.`simpeg_mt_induk_peg`.`V_NAMA_PEG` AS `V_NAMA_PEMOHON`,`skm_sima_but`.`simpeg_mt_induk_peg`.`V_KODE_UNIT` AS `V_KODE_PRODI_UNIT_PEMOHON`,`skm_sima_but`.`simpeg_mt_induk_peg`.`V_NAMA_UNIT` AS `V_NAMA_UNIT_PRODI_PEMOHON`,`skm_sima_but`.`simpeg_mt_induk_peg`.`V_EMAIL` AS `V_EMAIL_PEMOHON`,`skm_sima_but`.`simpeg_mt_induk_peg`.`V_TELP_HP` AS `V_TELP_HP_PEMOHON`,2 AS `N_STATUS_PEMOHON` from `skm_sima_but`.`simpeg_mt_induk_peg` ;
...
--
-- Indexes for table `akdadm_mt_mhs`
--
ALTER TABLE `akdadm_mt_mhs`
  ADD PRIMARY KEY (`V_NPM`);

--
-- Indexes for table `glb_mt_unit`
--
ALTER TABLE `glb_mt_unit`
  ADD PRIMARY KEY (`V_KODE_UNIT`);

--
-- Indexes for table `sima_acuan_aset_dt`
--
ALTER TABLE `sima_acuan_aset_dt`
  ADD KEY `ID_ASET` (`ID_ASET`),
  ADD KEY `ID_ACUAN` (`ID_ACUAN`);

--
-- Indexes for table `sima_aset_mt`
--
ALTER TABLE `sima_aset_mt`
  ADD PRIMARY KEY (`ID_ASET`),
  ADD KEY `ASET_KATEGORI_ID` (`ASET_KATEGORI_ID`),
  ADD KEY `ASET_LOKASI_ID` (`ASET_LOKASI_ID`);

--
-- Indexes for table `sima_barang_mt`
--
...
--
-- Indexes for table `sima_detil_peminjaman_dt`
--
ALTER TABLE `sima_detil_peminjaman_dt`
  ADD PRIMARY KEY (`ID_PEMINJAMAN`,`ID_ASET`),
  ADD KEY `fk_DETIL_PEMINJAMAN_DT_ASET_MT1_idx` (`ID_ASET`);

--
-- Indexes for table `sima_detil_peminjaman_kategori_spesifik_dt`
--
...
--
-- Indexes for table `sima_detil_peminjaman_perlengkapan_dt`
--
ALTER TABLE `sima_detil_peminjaman_perlengkapan_dt`
  ADD PRIMARY KEY (`ID_PEMINJAMAN`,`ID_PERLENGKAPAN`),
  ADD KEY `PERLENGKAPAN_MT_ID` (`ID_PERLENGKAPAN`);

--
-- Indexes for table `sima_fasilitas_glr_dt`
--
ALTER TABLE `sima_fasilitas_glr_dt`
  ADD KEY `ID_GLR` (`ID_GLR`),
  ADD KEY `ID_BARANG` (`ID_BARANG`);

--
-- Indexes for table `sima_glr_mt`
--
ALTER TABLE `sima_glr_mt`
  ADD PRIMARY KEY (`ID_GLR`),
  ADD UNIQUE KEY `ID_ASET` (`ID_ASET`),
  ADD KEY `PARENT_ID` (`PARENT_ID`);

--
-- Indexes for table `sima_kategori_mt`
--
ALTER TABLE `sima_kategori_mt`
  ADD PRIMARY KEY (`ID_KATEGORI`);

--
-- Indexes for table `sima_kategori_spesifik_mt`
--
ALTER TABLE `sima_kategori_spesifik_mt`
  ADD PRIMARY KEY (`ID_KATEGORI_SPESIFIK`);
...
--
-- Indexes for table `sima_lokasi_mt`
--
ALTER TABLE `sima_lokasi_mt`
...
--
-- Indexes for table `sima_pegawai_unpar_bertugas_dt`
--
ALTER TABLE `sima_pegawai_unpar_bertugas_dt`
  ADD PRIMARY KEY (`V_NO_PEG`,`ID_PEMINJAMAN`),
  ADD KEY `fk_PEGAWAI_UNPAR_BERTUGAS_DT_PEMINJAMAN_MT_idx` (`ID_PEMINJAMAN`);

--
-- Indexes for table `sima_peminjaman_tr`
--
ALTER TABLE `sima_peminjaman_tr`
  ADD PRIMARY KEY (`ID_PEMINJAMAN`),
  ADD KEY `fk_PEMINJAMAN_MT_GLB_MT_UNIT1_idx` (`V_KODE_UNIT_PEMOHON`),
  ADD KEY `fk_PEMINJAMAN_MT_AKDADM_MHS_MT.idx` (`V_KODE_PEMOHON_UNIT`),
  ADD KEY `fk_PEMINJAMAN_MT_SIMPEG_MT_INDUK_PEG` (`V_KODE_PEMOHON_UNIT`),
  ADD KEY `fk_PEMINJAMAN_MT__idx` (`V_KODE_PENANGGUNG_JAWAB_UNIT`),
  ADD KEY `V_KODE_PEMOHON_MAHASISWA` (`V_KODE_PEMOHON_MAHASISWA`),
  ADD KEY `V_KODE_PENANGGUNG_JAWAB_MAHASISWA` (`V_KODE_PENANGGUNG_JAWAB_MAHASISWA`);

--
-- Indexes for table `sima_perlengkapan_mt`
--
...
--
-- Indexes for table `sima_tabel_acuan_mt`
--
ALTER TABLE `sima_tabel_acuan_mt`
  ADD PRIMARY KEY (`ID_ACUAN`);

--
-- Indexes for table `sima_template_surat_mt`
--
ALTER TABLE `sima_template_surat_mt`
  ADD PRIMARY KEY (`ID_TEMPLATE`),
  ADD UNIQUE KEY `V_NAMA_TEMPLATE_UNIQUE` (`V_NAMA_TEMPLATE`),
  ADD UNIQUE KEY `N_JENIS_ACARA_UNIQUE` (`N_JENIS_ACARA`);

--
-- Indexes for table `simpeg_mt_induk_peg`
--
ALTER TABLE `simpeg_mt_induk_peg`
  ADD PRIMARY KEY (`V_NO_PEG`),
  ADD KEY `fk_SIMPEG_MT_INDUK_PEG_GLB_MT_UNIT_idx` (`V_KODE_UNIT`);
...
--
-- AUTO_INCREMENT for table `sima_aset_mt`
--
ALTER TABLE `sima_aset_mt`
  MODIFY `ID_ASET` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
--
-- AUTO_INCREMENT for table `sima_barang_mt`
--
ALTER TABLE `sima_barang_mt`
  MODIFY `ID_BARANG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `sima_glr_mt`
--
ALTER TABLE `sima_glr_mt`
  MODIFY `ID_GLR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `sima_kategori_mt`
--
ALTER TABLE `sima_kategori_mt`
  MODIFY `ID_KATEGORI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT for table `sima_kategori_spesifik_mt`
--
ALTER TABLE `sima_kategori_spesifik_mt`
  MODIFY `ID_KATEGORI_SPESIFIK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
-- AUTO_INCREMENT for table `sima_lokasi_mt`
--
ALTER TABLE `sima_lokasi_mt`
...
--
ALTER TABLE `sima_pegawai_luar_bertugas_dt`
  MODIFY `ID_PEGAWAI_LUAR_BERTUGAS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `sima_peminjaman_tr`
--
ALTER TABLE `sima_peminjaman_tr`
  MODIFY `ID_PEMINJAMAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT for table `sima_perlengkapan_mt`
--
ALTER TABLE `sima_perlengkapan_mt`
  MODIFY `ID_PERLENGKAPAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `sima_tabel_acuan_mt`
--
ALTER TABLE `sima_tabel_acuan_mt`
  MODIFY `ID_ACUAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `sima_template_surat_mt`
--
ALTER TABLE `sima_template_surat_mt`
